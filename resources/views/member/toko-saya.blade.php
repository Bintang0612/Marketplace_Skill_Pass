        ...
        <div class="card shadow-lg mb-4 p-3">
            <div class="row g-0 align-items-center">
                ...
                <div class="col-md-8 ps-4">
                    <h3 class="fw-bold">{{ $toko->nama_toko }}</h3>
                    ...
                    <button class="btn btn-danger ms-2" data-bs-toggle="modal" data-bs-target="#hapusTokoModal">
                        Hapus Toko
                    </button>
                </div>
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('produk.detail', $item->id) }}" class="btn btn-primary w-100">Detail</a>
                        </div>
                    </div>
